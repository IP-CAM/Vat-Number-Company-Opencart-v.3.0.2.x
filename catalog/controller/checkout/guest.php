...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		//Vat_plugin // V1.0 // 18.11

		if (isset($this->session->data['vat_private'])) {
			$data['vat_private'] = $this->session->data['vat_private'];
		} elseif (isset($this->session->data['vat_private'])) {
			$data['vat_private'] = $this->session->data['vat_private'];
		} else {
			$data['vat_private'] = '';
		}

		if (isset($this->session->data['vat_company'])) {
			$data['vat_company'] = $this->session->data['vat_company'];
		} elseif (isset($this->session->data['vat_company'])) {
			$data['vat_company'] = $this->session->data['vat_company'];
		} else {
			$data['vat_company'] = '';
		}

		if (isset($this->session->data['vat_name_company'])) {
			$data['vat_name_company'] = $this->session->data['vat_name_company'];
		} elseif (isset($this->session->data['vat_name_company'])) {
			$data['vat_name_company'] = $this->session->data['vat_name_company'];
		} else {
	...
	public function save() {
		...
		if (!$json) {
			...
			if ($tipclient == 1) {
				if (!isset($this->request->post['vat_private'])) {
					$json['error']['vat_private'] = $this->language->get('error_vat_private');
				}
			} elseif ($tipclient == 2) {
				if (!isset($this->request->post['vat_name_company']) || !isset($this->request->post['vat_company'])) {
					$json['error']['vat_name_company'] = $this->language->get('error_vat_name_company');
					$json['error']['vat_company'] = $this->language->get('error_vat_company');
				}
			}
			//VAT END
		...
		if (!$json) {
			...
			$this->session->data['vat_private'] = $this->request->post['vat_private'];
			$this->session->data['vat_company'] = $this->request->post['vat_company'];
			$this->session->data['vat_name_company'] = $this->request->post['vat_name_company'];
