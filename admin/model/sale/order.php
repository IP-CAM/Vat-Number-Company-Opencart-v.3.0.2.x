...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				//VAT
				'vat_private'             => $order_query->row['vat_private'],
				'vat_company'             => $order_query->row['vat_company'],
				'vat_name_company'        => $order_query->row['vat_name_company'],
				//VAT END
    ...
    public function get_vat_data($vat_order_id,$vat) {
    		$order_detail = array();
    		$order_detail = $this->getOrder($vat_order_id);
            $vat_private = $order_detail['vat_private'];
            $vat_name_company = $order_detail['vat_name_company'];
            $vat_company = $order_detail['vat_company'];
            if ($vat == 1){
                return $vat_private;
            }elseif ($vat == 2){
                return $vat_name_company;
            } else {
                return $vat_company;
            }
    }
