...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			//VAT 1.0
			$data['vat_private'] = $order_info['vat_private'];
			$data['vat_company'] = $order_info['vat_company'];
			$data['vat_name_company'] = $order_info['vat_name_company'];
			//END VAT
	...
	public function info() {
		...
		if ($order_info) {
            ...
            //Print Data
            $data['vat_private'] = $this->model_sale_order->get_vat_data($order_id,1);
            $data['vat_name_company'] = $this->model_sale_order->get_vat_data($order_id,2);
            $data['vat_company'] = $this->model_sale_order->get_vat_data($order_id,3);
            //Vat END
	...
	public function invoice() {
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				//Vat_plugin // V1.0 // 18.11
	            //Print Data
	            $vat_private = $this->model_sale_order->get_vat_data($order_id,1);
	            $vat_name_company = $this->model_sale_order->get_vat_data($order_id,2);
	            $vat_company = $this->model_sale_order->get_vat_data($order_id,3);
	            //Vat END
				...
				$replace = array(
					...
					'zone_code' => $order_info['payment_zone_code'],
					'country'   => $order_info['payment_country'],
					'vat_private'=> $vat_private,
					'vat_name_company'=> $vat_name_company,
